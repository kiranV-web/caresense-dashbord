...
export function mapCallListItem(item: BackendCallListItem): CallSummary {
  ...
  return {
    ...
    managerAttention: item.manager_attention ? {
      ...
      factors: item.manager_attention.factors,
      calculatedAt: item.manager_attention.calculated_at,
      waitingHours: item.manager_attention.waiting_hours,
      rank: item.manager_attention.rank,
      totalAttentionCalls: item.manager_attention.total_attention_calls,
      previousCallId: item.manager_attention.previous_call_id ?? undefined,
      nextCallId: item.manager_attention.next_call_id ?? undefined,
    } : undefined,
